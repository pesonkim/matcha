	...
	return (
		<div className='w-full flex items-center p-2 relative'>
			...
			<div className='flex flex-col w-full h-16 sm:h-20 pl-4 justify-center overflow-hidden'>
				...
				<span className='truncate text-sm sm:text-base'>Message body here Message body hereMessage body hereMessage body hereMessage body hereMessage body here</span>
			</div>
			<div className='bg-gradient-to-r from-transparent to-white absolute right-0 w-1/3 h-full rounded'></div>
			<div className='absolute right-0 bottom-0 w-3/4 sm:w-4/5 mx-4' style={divideStyle}></div>
		</div>
	)
}
